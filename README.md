...
<table style="width: 100%; border: none;">
  <tr style="border: none;">
    <td style="width: 50%; vertical-align: top; border: none; padding-right: 30px; font-size: 18px;">
      🎓 MSE, Scalable Systems @ Carnegie Mellon University - graduating Dec 2026<br><br>
      🔭 Currently building distributed data infrastructure at CMU's Manufacturing Futures Institute - database connectors, retrieval APIs, and observability tooling for industrial telemetry<br><br>
      🤖 Applied AI: fine-tuned transformer models (BERT/RoBERTa) for automated ESG scoring, and diffusion + LLM pipelines (Stable Diffusion, Mistral 7B) for generative packaging design - published in IEEE and Springer venues<br><br>
      🌱 Currently deepening Computer Vision, and building transformer internals, RAG pipelines, and MCP servers from first principles<br><br>
      💬 Always happy to talk distributed systems, applied ML, or anything at the intersection of infrastructure and intelligence<br><br>
      📫 Reach me at chandhokhargun@gmail.com<br><br>
      🔍 Open to full-time Software Engineer / AI Engineer roles
    </td>
    <td style="width: 50%; vertical-align: top; border: none;">
      <img src="memoji.png" alt="About Me Image" style="width: 500px; height: auto; border: none;" />
    </td>
  </tr>
</table>
